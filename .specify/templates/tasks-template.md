...
**Tests**: The examples below include test tasks. Tests for core logic are REQUIRED by constitution and MUST be included whenever a story modifies core behavior.
...
> **NOTE: For core logic, write these tests FIRST and ensure they FAIL before implementation**
